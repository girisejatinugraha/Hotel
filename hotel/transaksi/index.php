                ...
                <div class="card-body">
                  ...
                  ";
                      ?>
                        ...
                        &nbsp;
                        <a href="hapus.php?id_transaksi=<?= $row['id_transaksi']; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?')"><i class=' btn btn-danger py-0 px-1 far fa-trash-alt'></i></a>
                      <?php
                        echo "
                  </td>
                </tr>
