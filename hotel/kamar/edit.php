            ...
            <div class="col-md-8">
              ...
              <div class="card card-info">
                <div class="card-header">
                  <h5 class="text-center m-0">Perbarui Data Kamar</h5>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="post" action="">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="no_kamar" class="form-control" id="no_kamar" value="<?= $row['no_kamar']; ?>" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="deskripsi" class="form-control" id="deskripsi" required><?= $row['deskripsi']; ?></textarea>
                    </div>
                    <div class="form-group">
